...
# Parameters settings
# Data loading params
tf.flags.DEFINE_string("database_path", "final_dataset/", "Path for the dataset to be used.")
...
flags.DEFINE_integer("num_epochs", 10, "Number of training epochs (default: 100)")
...
def train(x_train, y_train, x_test, y_test):
    ...
    model.load_weights('./checkpoints/vdcnn_weights_val_acc_0.6634.h5',by_name=True)
    ...
    checkpointer = ModelCheckpoint(filepath="/checkpoints/vdcnn_weights_val_acc_0.5931.h5", period=1,
...
if __name__=='__main__':
    ...
    train(x_train[:100000], y_train[:100000], x_test[:100000], y_test[:100000])
